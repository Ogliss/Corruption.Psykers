        ...
        public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
        {
            for (int i = 0; i < this.parent.verb.verbProps.burstShotCount; i++)
            {
                ...
                if (this.verbProps.forcedMissRadius > 0.5f)
                {
                    ...
                    if (num > 0.5f)
                    {
                        ...
                        if (num2 > 0)
                        {
                            ...
                            projectile2.Launch(launcher, drawPos, c, target, projectileHitFlags, false, projectile2, null);
                            return;
                        }
                    }
                }
                ...
                if (!Rand.Chance(shotReport.AimOnTargetChance_IgnoringPosture))
                {
                    ...
                    projectile2.Launch(launcher, drawPos, shootLine.Dest, target, projectileHitFlags2, false, null, targetCoverDef);
                    return;
                }
                if (target.Thing != null && target.Thing.def.category == ThingCategory.Pawn && !Rand.Chance(shotReport.PassCoverChance))
                {
                    ...
                    projectile2.Launch(launcher, drawPos, randomCoverToMissInto, target, projectileHitFlags3, false, null, targetCoverDef);
                    return;
                }
                ...
                {
                    projectile2.Launch(launcher, drawPos, target, target, projectileHitFlags4, false, null, targetCoverDef);
                }
                else
                {
                    projectile2.Launch(launcher, drawPos, shootLine.Dest, target, projectileHitFlags4, false, null, targetCoverDef);
                }
            }
