...
namespace Corruption.Psykers
{
    ...
    public class HarmonyPatches
    {
        ...
        static HarmonyPatches()
        {
            ...
            Log.Message("Generating Pawn_EquipmentTracker Patch");
            ...
            Log.Message("Generating Pawn_ApparelTracker Patch");
            ...
            Log.Message("Generating Pawn Patch");
            ...
            Log.Message("Generating Pawn_PsychicEntropyTracker Patche");
            ...
            Log.Message("Generating Toils_Combat Patch");
            harmony.Patch(AccessTools.Method(typeof(Toils_Combat), "FollowAndMeleeAttack", null),null, new HarmonyMethod(typeof(HarmonyPatches), "FollowAndMeleeAttackPostfix"), null, null);
            Log.Message("Finished Generating Corruption Psykers Patches");
